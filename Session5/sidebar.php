    ...
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            <li style="padding: 70px 0 0;">
                <a href="ListProducts.php" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>List Products</a>
            </li>
            <li>
                <a href="AddProduct.php" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Add Product</a>
            </li>
            <li>
