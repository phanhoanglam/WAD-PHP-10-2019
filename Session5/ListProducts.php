...
<?php
$sql = "SELECT products.id, products.Name, product_categories.name as CategoryName, 
        description, price, products.image, created, discount FROM products
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $row['image']?>" width="20%" ></td>
                                                <td><?php echo $row['price']; ?></td>
                                                <td><?php echo $row['discount']; ?></td>
                                                <td><?php echo $row['created']; ?></td>
                                                <td>
                                                    <a href="EditProduct.php?edit=<?php echo $row['id']; ?>">Edit</a>
                                                    |
                                                    <a href="ListProducts.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
